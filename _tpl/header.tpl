  ...
  <a href="http://twitter.com/share"  data-text="{{ $gimme->article->name }}" data-via="{{ $gimme->publication->name }}">{{ #tweetOnTwitter# }}</a></li>
                          <li><div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=100924830001723&amp;xfbml=1"></script><fb:like href="http://{{ $gimme->publication->site }}{{ uri }}" send="true" width="385" show_faces="true" font=""></fb:like>  </li>
